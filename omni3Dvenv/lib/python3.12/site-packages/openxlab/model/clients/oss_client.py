...
from openxlab.model.common.constants import oss_bucket_domain, oss_endpoint_domain, oss_accelerate_domain
...
class OssClient(object):
    def __init__(self, endpoint, access_key_id, access_key_secret, security_token, bucket_name):
        self.bucket = self.get_bucket(endpoint, access_key_id, access_key_secret, security_token, bucket_name)
        self.cache_upload_id_key_prefix = f"model:oss:upload_id"
    ...
    def multipart_resume_upload(self, local_file_path, object_key, callback=None, callback_var=None, domain=None):
        ...
        try:
            ...
            with open(local_file_path, 'rb') as fileobj:
                ...
                for i in range(part_count):
                    ...
                    upload_part = self.bucket.upload_part(object_key, upload_id, part_number,
